<template>
    ...
    <nav>
        <ul id="menu"
            class="fixed z-20 text-xl lg:hidden flex flex-col items-center gap-8 p-8 bg-slate-800 w-full backdrop-shadow-md transition-top ease-in-out duration-1000"
